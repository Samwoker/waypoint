...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/events/replay-batch", post(events::replay_events_batch))
        .route("/events/:id", get(events::get_event).delete(events::delete_event))
        .route("/events/:id/raw", get(events::get_event_raw))
        .route("/events/:id/deliveries", get(events::get_event_deliveries))
        .route("/events/:id/replay", post(events::replay_event))
        .route("/events/:id/retry", post(events::retry_event))
        .route("/v1/events", get(events::list_events).post(events::create_event))
        .route("/v1/events/replay-batch", post(events::replay_events_batch))
        .route("/v1/events/:id", get(events::get_event).delete(events::delete_event))
        .route("/v1/events/:id/raw", get(events::get_event_raw))
        .route("/v1/events/:id/deliveries", get(events::get_event_deliveries))
        .route("/v1/events/:id/replay", post(events::replay_event))
        .route("/v1/events/:id/retry", post(events::retry_event))
        .route("/api/v1/events", get(events::list_events).post(events::create_event))
        .route("/api/v1/events/replay-batch", post(events::replay_events_batch))
        .route("/api/v1/events/:id", get(events::get_event).delete(events::delete_event))
        .route("/api/v1/events/:id/raw", get(events::get_event_raw))
        .route("/api/v1/events/:id/deliveries", get(events::get_event_deliveries))
        .route("/api/v1/events/:id/replay", post(events::replay_event))
        ...
        .route("/deliveries/:id/attempts", get(deliveries::list_delivery_attempts))
        .route("/deliveries/:id/replay", post(deliveries::replay_delivery))
        .route("/deliveries/:id/retry", post(deliveries::retry_delivery))
        ...
        .route("/v1/deliveries/:id/replay", post(deliveries::replay_delivery))
        ...
        .route("/api/v1/deliveries/:id/replay", post(deliveries::replay_delivery))
